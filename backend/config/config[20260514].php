...
// define('VAPID_PUBLIC_KEY',  getenv('VAPID_PUBLIC_KEY') ?: 'BFXgJYcirkUGNrWVbTD-u1RUBzfuqEV4V9WQ4S1em8_Ag7uQ0FWDeFuAZPno6aMCGMsW6n3OdH8IPnl3diE_KHM');
define('VAPID_PUBLIC_KEY',  getenv('VAPID_PUBLIC_KEY') ?: 'BBdpRYAcKnoBFsCYx12EFy57vpOKb8zJ93DJzfybF_rrxQ8rMUo9EPg_pfRcl5k2a27-ExBp7WS8VhLk9a2ed6w');
// define('VAPID_PRIVATE_KEY', getenv('VAPID_PRIVATE_KEY') ?: 'CVcSBaBsafKTDxIMrvJxtuqchTr8rydDI1PLI62mZ0I');
define('VAPID_PRIVATE_KEY', getenv('VAPID_PRIVATE_KEY') ?: 'NIxYRh57rANVeDfQ9rvo7WDut_PZPY7h9pSFfvIStSc');
